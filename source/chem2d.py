'''
idea: 
1: render a 2D structure of a molecule from smiles to svg, using rdkit
2. add this as the hoverover using dcc.tooltip
3. ... which means we need a graph of soemthing already, with st.plotly_element or whatever the api is
